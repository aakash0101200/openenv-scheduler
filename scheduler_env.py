...
class SchedulerEnv:
    ...
    def step(self, action: Action) -> Tuple[Observation, Reward, bool, dict[str, Any]]:
        ...
        if action.action_type == ActionType.QUERY_SCHEDULE:
            ...
            if action.room_id in self.rooms and action.time_slot not in self.rooms[action.room_id]:
            ...
            if self.task_level == 1:
                ...
                success = self.classes["CS101"]["status"] == "cancelled" and self.classes["MATH201"]["status"] == "cancelled" and "CS101" in self.notifications
            elif self.task_level == 3:
                success = self.classes["PHY301"]["room"] != "Auditorium" and "PHY301" in self.notifications
